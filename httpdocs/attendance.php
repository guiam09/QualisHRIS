                                                    ...
                                                    //   }
                                                      if($log > $maxlogs){
                                                          ...
                                                          if($stmt->execute()){
                                                            ...
                                                            //       while($row_getNewAttendanceId = $stmt_getNewAttendanceIdfetch(PDO::FETCH_ASSOC)){
                                                            //           $newAttendanceID = $stmt_getNewAttendanceIdfetch['attendanceID'];
                                                            //       }
                                                            //       //get updated by name
    ...
    // change query 08/02/2019
                                                ...
                                                //   $int = round($int,1,PHP_ROUND_HALF_DOWN);
                                                  ...
                                                  if(($decimalDigits)<0.5){
                                                    ...
                                                    if($int<0.5){
                                                        echo "<div class='alert alert-warning'>Attendance record has been voided!</div>";
                                                        $query = "DELETE FROM tbl_attendance WHERE employeeID = '$employeeID' AND attendance_timeOutDate = '$date_now' AND hourWorked=0 ";
                                                        $stmt = $con->prepare($query);
                                                        $stmt->execute();
                                                    }else{
                                                        echo "<div class='alert alert-success'>Time Out Success!</div>";
                                                        $query = "UPDATE tbl_attendance SET hourWorked = '$int', attendance_location='$loc' WHERE employeeID = '$employeeID' AND attendance_timeOutDate = '$date_now' AND hourWorked=0 ";
                                                        $stmt = $con->prepare($query);
                                                        $stmt->execute();
                                                    }
                                                }
                            ...
                            <div class="panel-body container-fluid">
                              <div>
                                ...
                                $query = "SELECT * FROM tbl_attendance INNER JOIN tbl_employees ON tbl_attendance.employeeID = tbl_employees.employeeID
                                            WHERE employeeCode='$userID' AND MONTH(attendanceDate)=MONTH(CURRENT_DATE()) AND YEAR(attendanceDate)=YEAR(CURRENT_DATE())  AND attendance_voided NOT LIKE 'VOID' ORDER BY attendanceDate DESC, attendance_timeIn DESC ";
                                $stmt = $con->prepare($query);
                                $stmt->execute();
                                        ...
                                        echo "
                                            <tr>";
                                                ...
                                                if($row["hourWorked"] == 0){
                                                    ...
                                                    echo "<td width='15%'>" . $row["hourWorked"] . "</td>";    
                                                }
                                            echo "</tr>";
                                    ...
                                    echo "
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <td width='20%'></td>
                                                <td width='10%'></td>
                                                <h2><th width='20%'>MONTHLY TOTAL</th></h2>
                                        ...
                                        <div class="form-group form-material col-md-12">
                                            ...
                                            <select class="form-control col-md-6" data-plugin="select2"  id="employeeId" name="employeeId" data-placeholder="Select Employee">
                                                ...
                                                <?php
                                                    ...
                                                    $query_employee = "SELECT * FROM tbl_employees  ORDER BY lastName ASC";
                                                    ...
                                                    echo  '<option value="'.$row_employee['employeeID'].'">'.$row_employee['lastName'].", ".$row_employee['firstName']." ".$row_employee['middleName']."</option>";
                            ...
                            <div class="panel">
                                ...
                                <div class="panel-body container-fluid">
                                    ...
                                    <table class="table table-hover dataTable table-striped w-full">
                                        <thead>
                                            <tr>
                                                <th width="90%">Max Log-in Count</th>
                    ...
                    <div class="modal-body ">
                        <div class='row'>
                            <div class='col-md-12'>
                                ...
                                <input class='form-control' autocomplete='off' type='text' name='updatedLimit' value='<?php echo $row_getPossibleAttendanceCount['attendanceDetails_maxtimein']; ?>' />
                            </div>
                        </div>                                                
                    </div>
                    <div class="modal-footer">
                        <button type="button"class="btn btn-default btn-outline" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
                        <button type="submit" class="btn btn-primary"  name="updateLimit"> <i class="fa fa-check-square-o" ></i> Update Time-in Limit</button>
                    </div>
                </div>
            </form>
        </div>
