...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <title>Qualis Consulting, Inc.</title>
    ...
    <script>
     ...
     <style>
             body { 
                    background-image: url("images/qualisQgray_scrn.png") !important;
                    /*background-color: linear-gradient(rgba(237, 33, 58, 1), rgba(147, 41, 30, 1));*/
