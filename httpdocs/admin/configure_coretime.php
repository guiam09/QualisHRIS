                          ...
                          <div class="panel-body">
                            <div class="tab-content">
                              <div class="tab-pane active" id="cardTab1" role="tabpanel">
                                <button type="button" data-target="#addCoretime" data-toggle="modal" class="btn btn-info waves-effect waves-classic">Add Core Time</button>
                               ...
                               while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                                 ...
                                 echo "        <tr>
                                   ...
                                   <a href='#' class='btn btn-info'
                                      data-original-title='Edit' data-toggle='modal' data-target='#editButton".$row['coreTimeID']."' data-id=" .  $row['coreTimeID'] . " ><i class='icon fa-edit' aria-hidden='true'></i>Edit</a>
                                   <a href='#' class='btn btn-danger'
                                      data-original-title='Remove' data-toggle='modal' data-target='#deleteButton".$row['coreTimeID']."' data-id=" .  $row['coreTimeID'] . "><i class='icon fa-trash' aria-hidden='true'></i>Delete</a>
                                 </td>
                                               </tr>";
                                               ?>
                                                       ...
                                                       <div class="modal-content">
                                                           ...
                                                           <div class="modal-footer">
                                                             <button  type="button"class="btn btn-default btn-outline" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
                                                              ...
                                                              <input type="hidden" name="formerName" value="<?php echo $row['coretimeName'] ?>">
