                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group form-material col-md-12">
                                                        ...
                                                        <select class="form-control col-md-3" data-plugin="select2" data-minimum-results-for-search="Infinity" data-placeholder="Select Range" width="auto" onchange="showDateRange(this.value)" />
                                                            <option value=""></option>
            ...
            <form method="post" action=".php" id='confirmLeaves'>
                <div class="modal-content">
                    ...
                    <div class="modal-body ">
                        <div class='row'>
                            <div class='col-md-12'>
                                <table class="table dataTable"  id="applyLeaveTable">
                                    <tr>
                                        <th>Leave Type</th>
                                        <th>Date</th>
                                        <th>Hours</th>
                                        <th>Reason</th>
                                        <th><button type="button" id="addFields" class="btn btn-success btn-sm fas fa-plus-square"></button></th>
                                    </tr>
                                    <tr>
                                        <td>
                                            <select class="form-control col-md-3" data-plugin="select2" data-minimum-results-for-search="Infinity">
                                            <!-- Query Leave Types -->
                                            <?php
                                            $query_leaveType = "SELECT * FROM tbl_leave";
                                                $stmt_leaveType = $con->prepare($query_leaveType);
                                        ...
                                        <td>
                                            <div class="col-md-12 input-group input-daterange" data-plugin="datepicker" id="currentDate">
                                                <input type="text" id="applyLeaveDate1" name="applyLeaveDate[]" class="form-control datepicker" autocomplete="off"/>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="col-md-12 input-group">
                                                <input type="text" id="applyLeaveReason1" name="applyLeaveReason[]" class="form-control" autocomplete="off" />
                                            </div>
                                        </td>
                                        <td>
...
//     html += '<tr>';
//     html += '<td><select class="form-control col-md-3" data-plugin="select2" data-minimum-results-for-search="Infinity"><?php echo generateLeaveDropdownList($con); ?></select></td>';
//     html += '<td>'
