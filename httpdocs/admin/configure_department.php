...
$CURRENT_PAGE="Config Designations";
                          ...
                          <div class="panel-body">
                            <div class="tab-content">
                              <div class="tab-pane active" id="cardTab1" role="tabpanel">
                                <button type="button" data-target="#addDepartment" data-toggle="modal" class="btn btn-default waves-effect waves-classic">Add Department</button>
                               ...
                               while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                                 echo "        <tr>
                                   ...
                                   <a href='#' class='btn btn-default'
                                      data-original-title='Edit' data-toggle='modal' data-target='#editButton".$row['departmentID']."' data-id=" .  $row['departmentID'] . " ><i class='icon fa-edit' aria-hidden='true'></i></a>
                                   <a href='#' class='btn btn-default'
                                      data-original-title='Remove' data-toggle='modal' data-target='#deleteButton".$row['departmentID']."' data-id=" .  $row['departmentID'] . "><i class='icon fa fa-close' aria-hidden='true'></i></a>
                                 </td>
                                               </tr>";
                                               ?>
                       <!-- <button type='button'  data-toggle='modal' data-target='#editButton".$row['leaveDetailsID']."' class='btn btn-success btn-sm edit btn-flat' data-id=" .  $row['employeeCode'] . "><i class='fa fa-check-square-o'></i> Update</button> -->
                                                       ...
                                                       <div class="modal-content">
                                                           ...
                                                           <div class="modal-footer">
                                                             <button  type="button"class="btn btn-default btn-outline" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
                                                               ...
                                                               <input type="hidden" name="formerName" value="<?php echo $row['departmentName'] ?>">
                                                             <button  type="submit" class="btn btn-default"name="editDepartment"><i class="fa fa-check-square-o"></i> Update Department Name</button>
                                                           </form>
                                                           </div>
                                                       </div>
                                                   </div>
                                                       ...
                                                       <div class="modal-content">
                                                           ...
                                                           <div class="modal-footer">
                                                             <button  type="button"class="btn btn-default btn-outline" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
                                                                 <input type="hidden" name="departmentID" value="<?php echo $row['departmentID'] ?>">
                                                                 <input type="hidden" name="formerName" value="<?php echo $row['departmentName'] ?>">
                                                             <button type="submit" class="btn btn-default" name="deleteDepartment"><i class="fa fa-check-square-o"></i> Delete Department</button>
                                               </form>
                                                           </div>
                                                       </div>
                                                   </div>
                           ...
                           ?>
                              ...
                              <div class="tab-pane" id="cardTab2" role="tabpanel">
                                  ...
                                  <button type="button" data-target="#addPosition" data-toggle="modal" class="btn btn-default waves-effect waves-classic">Add Position</button>
                                  <div class="panel-body container-fluid">
                           <br>
                             ...
                             if($num>0){
                               ...
                               while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                                 echo "        <tr>
                                                 ...
                                                 <td class='actions'>
                                   <a href='#' class='btn btn-default'
                                      data-original-title='Edit' data-toggle='modal' data-target='#positionEdit".$row['positionID']."' data-id=" .  $row['positionID'] . " ><i class='icon fa-edit' aria-hidden='true'></i></a>
                                   <a href='#' class='btn btn-default'
                                      data-original-title='Remove' data-toggle='modal' data-target='#positionDelete".$row['positionID']."' data-id=" .  $row['positionID'] . "><i class='icon fa fa-close' aria-hidden='true'></i></a>
                                 </td>
                                               </tr>";
                                               ?>
                                                       ...
                                                       <div class="modal-content">
                                                           ...
                                                           <div class="modal-footer">
                                                             <button type="button"class="btn btn-default btn-outline" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
                                                               ...
                                                               <input type="hidden" name="formerName" value="<?php echo $row['positionName'] ?>">
