...
<!--<select class="form-control col-md-6" data-plugin="select2"  id="employeeId" name="employeeId" data-placeholder="Select Employee">-->
    ...
    <?php
        ...
        echo  '<option value="'.$row_employee['lastName'].", ".$row_employee['firstName']." ".$row_employee['middleName'].'">'.$row_employee['lastName'].", ".$row_employee['firstName']." ".$row_employee['middleName'];
