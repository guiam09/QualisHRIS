        ...
        <div class='row' id="result">
            ...
            <div class='col-md-3'>
                <form method="POST" action="exportAttendanceCSV.php">
                    ...
                    <button type="submit" name="exportAttendanceRecords" value="printCsv" title='Download CSV file' class="btn btn-block btn-primary"><i class="fas fa-download"></i></button>
                </form>
            </div>
        </div>
        <br/>
                                        ...
                                        <div class="modal fade" id="editAttendanceModal<?php echo $attendanceID ?>" tabindex="-1" role="dialog" aria-labelledby="editAttendanceModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form class="form-horizontal" method="POST" id="modifyAttendance<?php echo $row_range['attendanceID']; ?>" name="modifyAttendance" action="attendance.php">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type='text' name="attendanceEditReason" class="form-control" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" class="btn btn-primary" name="save" value="save" id="saveButton<?php echo $row_range['attendanceID']; ?>" style="display: none;" onclick="updateData<?php echo $row_range['attendanceID']; ?>()">Save</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <?php
                                                                ...
                                                                while($row_displayUpdatesTable = $stmt_displayUpdatesTable->fetch(PDO::FETCH_ASSOC)){
                                                                    ...
                                                                    echo "
                                                                            <div class='col-md-2'>". $row_displayUpdatesTable['attendanceModification_activity'] ."</div>
                                                                            ...
                                                                            <div class='col-md-2'>". date("h:i:s A",strtotime($row_displayUpdatesTable['attendanceModification_modificationTime'])) ."</div>
                                        ...
                                        echo "<script type='text/javascript'>
                                            ...
                                            function updateData" . $row_range['attendanceID'] . "(){
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        data: {modifyTimeInValue:modifyTimeInValue, modifyTimeOutValue:modifyTimeOutValue, modifyLocationValue:modifyLocationValue, attendanceID:attendanceID},
                                                        dataType:'text',
                                            ...
                                            $('#modifyAttendance" . $row_range['attendanceID'] . "').on('change', 'modifyAttendance', function(){
                                            var initialTimeIn = $('#modifyTimeIn" . $row_range['attendanceID'] . "').val();
                                            var initialTimeOut = $('#modifyTimeOut" . $row_range['attendanceID'] . "').val();
                                            var initialLocation = $('#modifyLocation" . $row_range['attendanceID'] . "').val();
                                            var initialReason = $('#modifyReason" . $row_range['attendanceID'] . "').val();
                                             
                                            
                                            
                                            var modifiedTimeIn = $('#modifyTimeIn" . $row_range['attendanceID'] . "').val();
                                            var modifiedTimeOut = $('#modifyTimeOut" . $row_range['attendanceID'] . "').val();
                                            var modifiedLocation = $('#modifyLocation" . $row_range['attendanceID'] . "').val();
                                            var modifiedReason = $('#modifyReason" . $row_range['attendanceID'] . "').val();
                                            alert ('modifiedTimeIn');
                                            var initialValues = initialTimeIn.initialTimeOut.initialLocation.initialReason;
                                            var modifiedValues = modifiedTimeIn.modifiedTimeOut.modifiedLocation.modifiedReason;
                                            
                                                if (initialValues != modifiedValues){
                                                    document.getElementById('saveButton" . $row_range['attendanceID'] . "').style.display = 'block';
                                                } else {
                                                    document.getElementById('saveButton" . $row_range['attendanceID'] . "').style.display = 'none';
                                                }
                                            });
                                        </script>
                                        ";
