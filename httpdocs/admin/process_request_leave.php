...
if (isset($_POST['requestLeave'])){
  ...
  $q = "SELECT * FROM tbl_leaveinfo WHERE employeeID ='$user' AND leaveID = '$leave'";
...
try{
// insert query
$query = "INSERT INTO tbl_leavedetails SET employeeID=:employeeID, duration=:duration, leaveFrom=:leaveFrom, leaveTo=:leaveTo, reason=:reason, leaveStatus=:leaveStatus, approver=:approval, dateFiled=:dateFiled,
leaveID=:leaveID";
...
// end of accept leave
  ...
  echo  $status = $rowz['leaveStatus'];
    $empCode = $rowz['employeeID'];
    $leaveID = $rowz['leaveID'];
    $q3 = "SELECT * FROM tbl_leaveinfo WHERE employeeID = '$empCode' AND leaveID = $leaveID";
