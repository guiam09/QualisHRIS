                        ...
                        <div class="panel-body container-fluid">
                          ...
                          <br>
                            ...
                            <div class="row">
                              ...
                              <select class="form-control focus" title="Please Select Gender" required name="gender" data-plugin="selectpicker">
                                <option></option>
                              ...
                              <div class="form-group form-material col-md-4">
                                ...
                                <?php 
                                    include ('getCountryCode.php');
                                ?>
                                <input type="text" class="form-control focus" id="contactNumber" name="contactNumber" required maxlength="10"
                            ...
                            <div class="row">
                              ...
                              <select class="form-control focus" name="civilStatus" data-plugin="selectpicker" title="Please Select Civil Status" required>
                                <option></option>
                            ...
                            <div class="form-group form-material col-md-4">
                              ...
                              <input type="email" class="form-control focus" id="emailAddress" name="emailAddress"
                            ...
                            <div class="row">
                                ...
                                <input type="textarea" class="form-control focus" placeholder="Street, Village, City"name="address">
                              </div>
                            </div>
                            <!--<div class="row">-->
                            <!--  <div class="form-group form-material col-md-4">-->
                        ...
                        data-pattern="[[9999]]-[[9999]]-[[9999]]" />
                            <p class="text-help">1234-1234-1234</p>
                                ...
                                <!--</div>-->
                                  ...
                                  <select class="form-control focus" data-plugin="select2"  id="position" name="position" data-placeholder="Select Position">
                                    <option></option>
