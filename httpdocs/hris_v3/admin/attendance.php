                              ...
                              $sched = $row['coreTimeID'];
                                  ...
                                  if (isset($_POST['timeIn'])){
                                          ...
                                          if($num_checktimein > 0){
                                              ...
                                              if($num_logCounter > 0) {
                                                  ...
                                                  if($log > $maxlogs){
                                                      ...
                                                      if($stmt->execute()){
                                                          echo "<div class='alert alert-success'>Time In Success($log)!</div>";
                                                      }else{
                                                  ...
                                                  if($stmt->execute()){
                                                      echo "<div class='alert alert-success'>Time In Success(1)!</div>";
                                                  }else{
                                                      echo "<div class='alert alert-danger'>Time In Failed!</div>";
                                                  }
                                              }
                                      ...
                                      if($num_checktimeout < 1){
                                          ...
                                          $query = "UPDATE tbl_attendance SET attendance_timeOut = '$lognow', status='Offline' WHERE attendanceID = '".$row_checktimeout['attendanceID']."'";

                                          $stmt = $con->prepare($query);

                                          if($stmt->execute()){
                                              echo "<div class='alert alert-success'>Time Out Success(".$row_checktimeout['timeinLog'].")!</div>";
                              ...
                              <div class="row">
                                  <input type = "hidden" name ="time" value = "<?php echo date("His"); ?>">
                                        ...
                                        <div class="form-group">
                                            <button type="submit" name="timeIn" class="btn btn-block btn-primary">Time-In</button>
                                                    </div>
                                        </div>
                                        <div class="col-md-6">
                                        <div class="form-group">
                                            <button type="submit" name="timeOut" class="btn btn-block btn-primary">Time-Out</button>
                                                    </div>
                                </div>
