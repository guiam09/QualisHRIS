                          ...
                          <div class="panel-body">
                            <div class="tab-content">
                              <div class="tab-pane active" id="cardTab1" role="tabpanel">
                                ...
                                ?>
                                <button type="button" data-target="#addLeave" data-toggle="modal" class="btn btn-primary waves-effect waves-classic">Add Leave Type</button>
                                <br><br><br>
                                      ...
                                      while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                                        ...
                                        echo "        <tr>
                                          ...
                                          <a href='#' class='btn btn-sm btn-icon btn-pure btn-default on-default edit-row'
                                             data-original-title='Edit' data-toggle='modal' data-target='#editButton".$row['leaveID']."' data-id=" .  $row['leaveID'] . " ><i class='icon md-edit' aria-hidden='true'></i></a>
                                          <a href='#' class='btn btn-sm btn-icon btn-pure btn-default on-default remove-row'
                                             data-original-title='Remove' data-toggle='modal' data-target='#deleteButton".$row['leaveID']."' data-id=" .  $row['leaveID'] . "><i class='icon md-delete' aria-hidden='true'></i></a>
                                        </td>
                                                      </tr>";
